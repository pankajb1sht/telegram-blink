...
export function BlinkForm({ onClose }: BlinkFormProps) {
  ...
  return (
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 p-8 bg-black/90 rounded-2xl border border-violet-500/30 backdrop-blur-sm max-w-xl w-full mx-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <label
                ...
                className="flex items-center justify-center w-full px-4 py-3 rounded-xl bg-white/5 border border-violet-500/30 text-gray-300 hover:bg-violet-500/10 transition-all duration-200 cursor-pointer group"

              >

                <Upload className="mr-2 group-hover:scale-110 transition-transform duration-200" size={20} />
